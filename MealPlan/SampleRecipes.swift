...
struct SampleRecipes {
    ...
    private static let balanced: [Recipe] = [
        Recipe(name: "燕麦莓果碗", mealType: .breakfast, ingredients: [
            Ingredient(name: "盐", quantity: 1, unit: "g", category: .spices, prepMinutes: 10, cookMinutes: 15),
    ...
    private static let chinese: [Recipe] = [
        Recipe(name: "麻婆豆腐", nameEn: "Mapo Tofu", mealType: .lunch, ingredients: [
            Ingredient(name: "豆腐", quantity: 200, unit: "g", category: .protein, prepMinutes: 10, cookMinutes: 15),
            Ingredient(name: "肉末", quantity: 80, unit: "g", category: .protein),
            Ingredient(name: "豆瓣酱", quantity: 15, unit: "g", category: .spices)
        ], instructions: "豆腐切块焯水；热锅下油炒香豆瓣酱和肉末，加水下豆腐小火煮，淋水淀粉勾芡。", instructionsEn: "See Chinese steps", nutrition: "川菜经典", nutritionEn: "Sichuan style", prepMinutes: 10, cookMinutes: 12, cuisine: "川菜"),
        Recipe(name: "酸菜鱼", nameEn: "Sour Fish", mealType: .dinner, ingredients: [
            Ingredient(name: "鱼片", quantity: 200, unit: "g", category: .protein, prepMinutes: 10, cookMinutes: 15),
            Ingredient(name: "酸菜", quantity: 120, unit: "g", category: .produce),
            Ingredient(name: "泡椒", quantity: 10, unit: "g", category: .spices)
        ], instructions: "酸菜炒香加水煮开，下鱼片煮熟，淋热油增香。", instructionsEn: "See Chinese steps", nutrition: "川味酸辣", nutritionEn: "Sichuan style", prepMinutes: 12, cookMinutes: 10, cuisine: "川菜"),
        ...
        ], instructions: "豆腐切块铺盘，放剁椒和葱姜，上锅蒸8分钟，淋热油。", instructionsEn: "See Chinese steps", nutrition: "湘菜风味", nutritionEn: "Hunan style", prepMinutes: 8, cookMinutes: 8, cuisine: "湘菜"),
        Recipe(name: "萝卜牛腩汤", nameEn: "Radish Beef Soup", mealType: .dinner, ingredients: [
            Ingredient(name: "牛腩", quantity: 200, unit: "g", category: .protein, prepMinutes: 10, cookMinutes: 15),
            Ingredient(name: "白萝卜", quantity: 200, unit: "g", category: .produce),
            Ingredient(name: "姜", quantity: 5, unit: "g", category: .spices)
        ], instructions: "牛腩焯水后加姜片炖20分钟；加入萝卜再煮15分钟。", instructionsEn: "See Chinese steps", nutrition: "清润汤品", nutritionEn: "Soup", prepMinutes: 10, cookMinutes: 35, isSoup: true, cuisine: "家常")
        Recipe(name: "宫保鸡丁", nameEn: "Kung Pao Chicken", mealType: .lunch, ingredients: [
            Ingredient(name: "鸡胸肉", quantity: 180, unit: "g", category: .protein, prepMinutes: 10, cookMinutes: 15),
        ...
        Recipe(name: "剁椒鱼头", nameEn: "Chopped Chili Fish Head", mealType: .dinner, ingredients: [
            Ingredient(name: "鱼头", quantity: 1, unit: "份", category: .protein, prepMinutes: 10, cookMinutes: 15),
        ...
        Recipe(name: "回锅肉", nameEn: "Twice-Cooked Pork", mealType: .dinner, ingredients: [
            Ingredient(name: "五花肉", quantity: 200, unit: "g", category: .protein, prepMinutes: 10, cookMinutes: 15),
        ...
        Recipe(name: "小炒黄牛肉", nameEn: "Stir-fried Beef", mealType: .lunch, ingredients: [
            Ingredient(name: "牛肉", quantity: 180, unit: "g", category: .protein, prepMinutes: 10, cookMinutes: 15),
        ...
        Recipe(name: "紫菜蛋花汤", nameEn: "Seaweed Egg Soup", mealType: .dinner, ingredients: [
            Ingredient(name: "紫菜", quantity: 5, unit: "g", category: .pantry, prepMinutes: 10, cookMinutes: 15),
        ...
        Recipe(name: "酸辣汤", nameEn: "Hot and Sour Soup", mealType: .lunch, ingredients: [
            Ingredient(name: "木耳", quantity: 10, unit: "g", category: .produce, prepMinutes: 10, cookMinutes: 15),
        ...
        Recipe(name: "冬瓜排骨汤", nameEn: "Winter Melon Rib Soup", mealType: .dinner, ingredients: [
            Ingredient(name: "排骨", quantity: 200, unit: "g", category: .protein, prepMinutes: 10, cookMinutes: 15),
            Ingredient(name: "冬瓜", quantity: 200, unit: "g", category: .produce),
            Ingredient(name: "姜", quantity: 5, unit: "g", category: .spices)
        ...
        Recipe(name: "番茄炒蛋", nameEn: "Tomato Egg Stir-fry", mealType: .dinner, ingredients: [
            Ingredient(name: "鸡蛋", quantity: 2, unit: "pcs", category: .protein, prepMinutes: 10, cookMinutes: 15),
            Ingredient(name: "番茄", quantity: 150, unit: "g", category: .produce),
