...
struct SampleRecipes {
    ...
    private static let balanced: [Recipe] = [
        Recipe(name: "燕麦莓果碗", mealType: .breakfast, ingredients: [
            Ingredient(name: "盐", quantity: 1, unit: "g", category: .spices, calories: 420, protein: 30, carbs: 50, fat: 14),
    ...
    private static let chinese: [Recipe] = [
        ...
        ], instructions: "豆浆加热；油条回烤1–2分钟更酥。", instructionsEn: "Heat soy milk and warm youtiao.", nutrition: "中式早餐", nutritionEn: "Chinese breakfast", prepMinutes: 5, cookMinutes: 3, cuisine: "家常", isSoup: false, calories: 450, protein: 16, carbs: 55, fat: 18),
        ...
        ], instructions: "大米加水煮粥30分钟；瘦肉切丝腌制后下锅煮熟，加入皮蛋块再煮5分钟。", instructionsEn: "Simmer rice into congee, add pork and century egg.", nutrition: "暖胃", nutritionEn: "Comforting", prepMinutes: 10, cookMinutes: 35, cuisine: "家常", isSoup: true, calories: 380, protein: 22, carbs: 50, fat: 8),
        ...
        ], instructions: "葱段小火熬香葱油；面条煮熟拌入葱油和酱油。", instructionsEn: "Cook noodles and toss with scallion oil.", nutrition: "家常", nutritionEn: "Home-style", prepMinutes: 8, cookMinutes: 8, cuisine: "家常", isSoup: false, calories: 420, protein: 14, carbs: 70, fat: 10),
        Recipe(name: "麻婆豆腐", nameEn: "Mapo Tofu", mealType: .lunch, ingredients: [
            Ingredient(name: "豆腐", quantity: 200, unit: "g", category: .protein, calories: 420, protein: 30, carbs: 50, fat: 14),
        ...
        Recipe(name: "酸菜鱼", nameEn: "Sour Fish", mealType: .dinner, ingredients: [
            Ingredient(name: "鱼片", quantity: 200, unit: "g", category: .protein, calories: 420, protein: 30, carbs: 50, fat: 14),
        ...
        Recipe(name: "萝卜牛腩汤", nameEn: "Radish Beef Soup", mealType: .dinner, ingredients: [
            Ingredient(name: "牛腩", quantity: 200, unit: "g", category: .protein, calories: 420, protein: 30, carbs: 50, fat: 14),
        ...
        Recipe(name: "宫保鸡丁", nameEn: "Kung Pao Chicken", mealType: .lunch, ingredients: [
            Ingredient(name: "鸡胸肉", quantity: 180, unit: "g", category: .protein, calories: 420, protein: 30, carbs: 50, fat: 14),
        ...
        Recipe(name: "剁椒鱼头", nameEn: "Chopped Chili Fish Head", mealType: .dinner, ingredients: [
            Ingredient(name: "鱼头", quantity: 1, unit: "份", category: .protein, calories: 420, protein: 30, carbs: 50, fat: 14),
        ...
        Recipe(name: "回锅肉", nameEn: "Twice-Cooked Pork", mealType: .dinner, ingredients: [
            Ingredient(name: "五花肉", quantity: 200, unit: "g", category: .protein, calories: 420, protein: 30, carbs: 50, fat: 14),
        ...
        Recipe(name: "小炒黄牛肉", nameEn: "Stir-fried Beef", mealType: .lunch, ingredients: [
            Ingredient(name: "牛肉", quantity: 180, unit: "g", category: .protein, calories: 420, protein: 30, carbs: 50, fat: 14),
        ...
        Recipe(name: "紫菜蛋花汤", nameEn: "Seaweed Egg Soup", mealType: .dinner, ingredients: [
            Ingredient(name: "紫菜", quantity: 5, unit: "g", category: .pantry, calories: 420, protein: 30, carbs: 50, fat: 14),
        ...
        Recipe(name: "酸辣汤", nameEn: "Hot and Sour Soup", mealType: .lunch, ingredients: [
            Ingredient(name: "木耳", quantity: 10, unit: "g", category: .produce, calories: 420, protein: 30, carbs: 50, fat: 14),
        ...
        Recipe(name: "冬瓜排骨汤", nameEn: "Winter Melon Rib Soup", mealType: .dinner, ingredients: [
            Ingredient(name: "排骨", quantity: 200, unit: "g", category: .protein, calories: 420, protein: 30, carbs: 50, fat: 14),
            Ingredient(name: "冬瓜", quantity: 200, unit: "g", category: .produce),
            Ingredient(name: "姜", quantity: 5, unit: "g", category: .spices)
        ...
        Recipe(name: "番茄炒蛋", nameEn: "Tomato Egg Stir-fry", mealType: .dinner, ingredients: [
            Ingredient(name: "鸡蛋", quantity: 2, unit: "pcs", category: .protein, calories: 420, protein: 30, carbs: 50, fat: 14),
            Ingredient(name: "番茄", quantity: 150, unit: "g", category: .produce),
